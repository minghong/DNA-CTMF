...
original_image_name="lena.bmp"
reconstructed_image_name="256_1.0_median.bmp"
img1 = cv2.imread(original_image_name,cv2.IMREAD_GRAYSCALE)
img3 = cv2.imread(reconstructed_image_name,cv2.IMREAD_GRAYSCALE)
...
print(round(mssim_1(img1, img3),3))
